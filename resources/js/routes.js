export default [
        ...
        children: [
            {
                path: "/databases",
                name: "databases",
                component: require("./components/Databases.vue").default
            },
            {
                path: "/employees",
                name: "employees",
            ...
            },
            {
                path: "/histories",
                name: "histories",
                component: require("./components/Histories.vue").default
            },
            {
                path: "/about",
                name: "about",
    ...
    {
        path: "*",
        component: require("./components/NotFound404.vue").default
    }
];
