...
<div>
    <b-navbar toggleable="lg" type="dark" variant="dark">
        <b-navbar-brand href="#">CADWAR</b-navbar-brand>
        ...
        <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav >
                ...
                <b-nav-item>
                    <router-link :to="{name:'databases'}" title="Базы">Базы</router-link>
                </b-nav-item>
                <b-nav-item>
                    <router-link :to="{name:'employees'}" title="Работники">Работники</router-link>
                </b-nav-item>
                <b-nav-item>
                    <router-link :to="{name:'histories'}" title="Истории">Истории</router-link>
                </b-nav-item>
            </b-navbar-nav>
